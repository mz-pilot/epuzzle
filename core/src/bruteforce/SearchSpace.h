...
namespace epuzzle::details::bruteforce
{
    ...
    public:
        ...
        virtual std::uint64_t totalSolutionCandidates() const = 0;
        ...
        [[nodiscard]] std::unique_ptr<SearchSpaceCursor> createCursor() const { return createCursor(0, totalSolutionCandidates()); }
    };
}
