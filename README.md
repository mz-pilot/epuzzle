...
* [Полное руководство пользователя](#полное-руководство-пользователя)
  * [Работа с паззлами](#работа-с-паззлами)
...
В дистрибутив включены папка puzzle_examples c примерами готовых паззлов (файлы `.toml`). Каждому соответствует `.txt` файл с описанием головоломки на естественном языке.

Самый простой способ составить свой собственный паззл - скопировать один из паззлов-примеров (**`einsteins.toml`** или **`four_girls.toml`**) в рабочую папку и переписать его под свою собственную головоломку.

Примеры паззлов снабжены комментариями (комментарий начинается с символа '#'). 

<details>
<summary><h4> Развернуть >> Подробнее про формат TOML-файла с паззлом</h4></summary>
...
<details>
<summary><h4> Развернуть >> Описание режимов работы</h4></summary>
