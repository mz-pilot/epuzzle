...
В дистрибутив включена папка **`puzzle_examples`** c примерами готовых паззлов (файлы `.toml`). Каждому соответствует `.txt` файл с описанием головоломки на естественном языке.
