...
Modern C++20 библиотека и консольная утилита для решения логических головоломок (таких как [Загадка Эйнштейна](https://ru.wikipedia.org/wiki/Загадка_Эйнштейна) ([Zebra Puzzle](https://en.wikipedia.org/wiki/Zebra_Puzzle)) и аналогичных задач на удовлетворение ограничений). Проект разработан как демонстрация профессиональных навыков с кроссплатформенной системой сборки CMake, комплексным модульным тестированием и CI/CD пайплайнами на GitHub Actions.
